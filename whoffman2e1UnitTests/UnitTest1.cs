...
namespace LogicalOperationsUnitTests
{
    ...
    public class UnitTest1
    {
        ...
        {
            Assert.IsFalse(LogicalOperations.q11(false, 24.99m, 1.1m));
        }
        [TestMethod]
        public void TestQ11FreeShippingToMembers()
        {
            Assert.IsTrue(LogicalOperations.q11(true, 24.99m, 1.1m));
        }
        [TestMethod]
        public void TestQ11FreeShippingOver25()
        {
            Assert.IsTrue(LogicalOperations.q11(false, 25m, 1.1m));
        }
        [TestMethod]
        public void TestQ11FreeShipping1OunceOrLess()
        {
            Assert.IsTrue(LogicalOperations.q11(false, 24.99m, 1.0m));
        }
        [TestMethod]
        public void TestQ12NotFreeShipping()
        {
            Assert.IsFalse(LogicalOperations.q12(false, 24.99m, 1.0m));
        }
        [TestMethod]
        public void TestQ12FreeShippingToMembers()
        {
            Assert.IsTrue(LogicalOperations.q12(true, 24.99m, 1.0m));
        }
        [TestMethod]
        public void TestQ12FreeShippingPriceOver25WeightUnder1()
        {
            Assert.IsTrue(LogicalOperations.q12(false, 25.0m, 0.99m));
        }
        [TestMethod]
