...
namespace whoffman2e1
{
    public class LogicalOperations
    {
        ...
        public static bool q11(bool member, decimal price, decimal weight)
        {
            return member == true || price >= 25m || weight <= 1.0m;
        }

        public static bool q12(bool member, decimal price, decimal weight)
        {
            return member == true || price >= 25m && weight < 1.0m;
        }

        public static bool q13(string state, string department)
        {
            return state == "MN" && !(department == "Clothing" || department == "Food");
        }
    }
}
